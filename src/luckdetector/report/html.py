...
CAVEATS: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "Three of the four thresholds are conventional; the precedence, the asymmetry "
        "and the carve-out that stops a Probabilistic Sharpe Ratio ever certifying "
        "skill on its own are judgements. See docs/BLUEPRINT.md §5.7.",
    ),
)
...
<article class="v-{{ verdict_class }}">
  ...
  <p class="colophon">
    ...
    <code>docs/BLUEPRINT.md</code>. This file is self-contained — both figures are embedded,
